    ...
    <body>
        ...
        <form id="codeForm" onsubmit="event.preventDefault();">
            <fieldset><legend>Saisie d'un bon de commande</legend>
                Numéro du bon de commande : <input id="code" name="code" value="${code}" type="number" required><br/>
                ...
                <input type="submit" id="Modifier" value="Modifier" onclick="modify()">
                <input type="submit" id="ToutEffacer" value="Effacer">
            </fieldset>
        </form>
