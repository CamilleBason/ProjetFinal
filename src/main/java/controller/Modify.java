...
public class Modify extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            dao.modifPurchaseOrder(Integer.valueOf(numC), Integer.valueOf(client), Integer.valueOf(prodid), Integer.valueOf(quantite), Float.valueOf(fraisPort), dateVenteSQL, dateExpSQL, transport);
